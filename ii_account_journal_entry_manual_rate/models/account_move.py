...
class AccountMoveLine(models.Model):
    ...
    def _compute_currency_rate(self):
        ...
        for line in self:
            currency_rate = 1
            if line.currency_id and self.env.company.currency_id and (line.currency_id != self.env.company.currency_id) and (line.custom_rate > 1):
    ...
    @api.onchange('amount_currency', 'currency_id', 'custom_rate')

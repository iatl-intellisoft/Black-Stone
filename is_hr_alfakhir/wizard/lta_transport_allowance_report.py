...
class WizardLtaTransport(models.Model):
    ...
    def print_report(self):
        for report in self:
            ...
            excel_sheet_transport.merge_range(0, 0, 1, 7, 'alfakhir International Investment Co.LTD', title_format)
            excel_sheet_transport.merge_range(2, 0, 3, 7, report_title, title_format)
            excel_sheet_lta.merge_range(0, 0, 1, 7, 'alfakhir International Investment Co.LTD', title_format)
